...
--
-- Name: log_archive_copy1; Type: TABLE; Schema: public; Owner: cdms
--

CREATE TABLE public.log_archive_copy1 (
    logid uuid NOT NULL,
    horodatage timestamp(6) with time zone,
    operation text,
    userid text,
...
ALTER TABLE public.log_archive_copy1 OWNER TO cdms;

--
-- Name: COLUMN log_archive_copy1.logid; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.logid IS 'Id log';


--
-- Name: COLUMN log_archive_copy1.horodatage; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.horodatage IS 'Date d''archivage';


--
-- Name: COLUMN log_archive_copy1.operation; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.operation IS 'Opération';


--
-- Name: COLUMN log_archive_copy1.userid; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.userid IS 'ID utilisateur';


--
-- Name: COLUMN log_archive_copy1.docid; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.docid IS 'Id document archivé';


--
-- Name: COLUMN log_archive_copy1.mailid; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.mailid IS 'Adresse mail';


--
-- Name: COLUMN log_archive_copy1.docsname; Type: COMMENT; Schema: public; Owner: cdms
--

COMMENT ON COLUMN public.log_archive_copy1.docsname IS 'Nom de l''archive';
...
--
-- Data for Name: log_archive_copy1; Type: TABLE DATA; Schema: public; Owner: cdms
--

COPY public.log_archive_copy1 (logid, horodatage, operation, userid, docid, mailid, docsname, logtype, timestamptoken, hash, attestation) FROM stdin;
\.
...
--
-- Name: log_archive_copy1 log_archive_copy1_pkey; Type: CONSTRAINT; Schema: public; Owner: cdms
--

ALTER TABLE ONLY public.log_archive_copy1
    ADD CONSTRAINT log_archive_copy1_pkey PRIMARY KEY (logid);
